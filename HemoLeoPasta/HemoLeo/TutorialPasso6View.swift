...
class TutorialPasso6View : UIView, CAAnimationDelegate {
	...
	func setupHierarchy() {
		...
		mãoPegar__root.layer.position = CGPoint(x:300.000, y:208.940)
		...
		let seringaCheia__root = TutorialPasso6PassthroughView()
		let seringaCheia__xScale = TutorialPasso6PassthroughView()
		let seringaCheia__yScale = TutorialPasso6PassthroughView()
		let seringaCheia = UIView()
		seringaCheia.bounds = CGRect(x:0, y:0, width:362.9, height:405.0)
		seringaCheia__root.layer.position = CGPoint(x:223.771, y:248.451)
		seringaCheia__xScale.transform = CGAffineTransform(scaleX: 1.00, y: 1.00)
		seringaCheia__yScale.transform = CGAffineTransform(scaleX: 1.00, y: 1.00)
		seringaCheia__root.transform = CGAffineTransform(rotationAngle: 0.000)
		__scaling__.addSubview(seringaCheia__root)
		...
		capa__root.layer.position = CGPoint(x:181.383, y:202.253)
		...
		seringaCheia.addSubview(capa__root)
		...
		embolo__root.layer.position = CGPoint(x:181.000, y:202.631)
		...
		seringaCheia.addSubview(embolo__root)
		...
		liquido__root.layer.position = CGPoint(x:181.194, y:202.869)
		...
		seringaCheia.addSubview(liquido__root)
		...
		linha1__root.layer.position = CGPoint(x:181.904, y:202.964)
		...
		seringaCheia.addSubview(linha1__root)
		...
		linha2__root.layer.position = CGPoint(x:181.246, y:202.230)
		...
		seringaCheia.addSubview(linha2__root)
		...
		let medidaP6__root = TutorialPasso6PassthroughView()
		let medidaP6__xScale = TutorialPasso6PassthroughView()
		let medidaP6__yScale = TutorialPasso6PassthroughView()
		let medidaP6 = UIImageView()
		let imgMedidaP6 = UIImage(named:"MedidaP6.png", in: bundle, compatibleWith: nil)
		if imgMedidaP6 == nil {
			print("** Warning: Could not create image from 'MedidaP6.png'")
		}
		medidaP6.image = imgMedidaP6
		medidaP6.contentMode = .center
		medidaP6.bounds = CGRect(x:0, y:0, width:362.0, height:404.0)
		medidaP6__root.layer.position = CGPoint(x:181.000, y:202.000)
		medidaP6__xScale.transform = CGAffineTransform(scaleX: 1.00, y: 1.00)
		medidaP6__yScale.transform = CGAffineTransform(scaleX: 1.00, y: 1.00)
		medidaP6__root.transform = CGAffineTransform(rotationAngle: 0.000)
		seringaCheia.addSubview(medidaP6__root)
		medidaP6__root.addSubview(medidaP6__xScale)
		medidaP6__xScale.addSubview(medidaP6__yScale)
		medidaP6__yScale.addSubview(medidaP6)
		seringaCheia.addSubview(medidaP6__root)
		viewsByName["MedidaP6__root"] = medidaP6__root
		viewsByName["MedidaP6__xScale"] = medidaP6__xScale
		viewsByName["MedidaP6__yScale"] = medidaP6__yScale
		viewsByName["MedidaP6"] = medidaP6
		...
		let garroteP6__root = TutorialPasso6PassthroughView()
		let garroteP6__xScale = TutorialPasso6PassthroughView()
		let garroteP6__yScale = TutorialPasso6PassthroughView()
		let garroteP6 = UIImageView()
		let imgGarroteP6 = UIImage(named:"GarroteP6.png", in: bundle, compatibleWith: nil)
		if imgGarroteP6 == nil {
			print("** Warning: Could not create image from 'GarroteP6.png'")
		}
		garroteP6.image = imgGarroteP6
		garroteP6.contentMode = .center
		garroteP6.bounds = CGRect(x:0, y:0, width:362.0, height:404.0)
		garroteP6__root.layer.position = CGPoint(x:212.000, y:257.000)
		garroteP6__xScale.transform = CGAffineTransform(scaleX: 1.00, y: 1.00)
		garroteP6__yScale.transform = CGAffineTransform(scaleX: 1.00, y: 1.00)
		garroteP6__root.transform = CGAffineTransform(rotationAngle: 0.000)
		__scaling__.addSubview(garroteP6__root)
		garroteP6__root.addSubview(garroteP6__xScale)
		garroteP6__xScale.addSubview(garroteP6__yScale)
		garroteP6__yScale.addSubview(garroteP6)
		__scaling__.addSubview(garroteP6__root)
		viewsByName["GarroteP6__root"] = garroteP6__root
		viewsByName["GarroteP6__xScale"] = garroteP6__xScale
		viewsByName["GarroteP6__yScale"] = garroteP6__yScale
		viewsByName["GarroteP6"] = garroteP6
		...
		mãoDedo__root.layer.position = CGPoint(x:300.000, y:208.000)
	...
	func addPasso6Animation(beginTime: CFTimeInterval, fillMode: String, removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
		...
		mãoPressionaTranslationXAnimation.values = [0.000, 0.000, -135.271, -135.000, 0.000, 0.000] as [Float]
		...
		let medidaP6OpacityAnimation = CAKeyframeAnimation(keyPath: "opacity")
		medidaP6OpacityAnimation.duration = 15.000
		medidaP6OpacityAnimation.values = [1.000, 1.000, 0.000, 0.000] as [Float]
		medidaP6OpacityAnimation.keyTimes = [0.000, 0.600, 0.633, 1.000] as [NSNumber]
		medidaP6OpacityAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		medidaP6OpacityAnimation.beginTime = beginTime
		medidaP6OpacityAnimation.fillMode = fillMode
		medidaP6OpacityAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["MedidaP6__root"]?.layer.add(medidaP6OpacityAnimation, forKey:"Passo6_Opacity")

		let medidaP6TranslationXAnimation = CAKeyframeAnimation(keyPath: "transform.translation.x")
		medidaP6TranslationXAnimation.duration = 15.000
		medidaP6TranslationXAnimation.values = [0.000, 0.000, 208.000, 208.000] as [Float]
		medidaP6TranslationXAnimation.keyTimes = [0.000, 0.540, 0.600, 1.000] as [NSNumber]
		medidaP6TranslationXAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		medidaP6TranslationXAnimation.beginTime = beginTime
		medidaP6TranslationXAnimation.fillMode = fillMode
		medidaP6TranslationXAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["MedidaP6__root"]?.layer.add(medidaP6TranslationXAnimation, forKey:"Passo6_TranslationX")

		let medidaP6TranslationYAnimation = CAKeyframeAnimation(keyPath: "transform.translation.y")
		medidaP6TranslationYAnimation.duration = 15.000
		medidaP6TranslationYAnimation.values = [0.000, 0.000, 82.000, 82.000] as [Float]
		medidaP6TranslationYAnimation.keyTimes = [0.000, 0.540, 0.600, 1.000] as [NSNumber]
		medidaP6TranslationYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		medidaP6TranslationYAnimation.beginTime = beginTime
		medidaP6TranslationYAnimation.fillMode = fillMode
		medidaP6TranslationYAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["MedidaP6__root"]?.layer.add(medidaP6TranslationYAnimation, forKey:"Passo6_TranslationY")
		...
		mãoPegarTranslationXAnimation.values = [0.000, 0.000, -130.000, -130.000, 77.908, 77.908] as [Float]
		...
		mãoPegarTranslationYAnimation.values = [0.000, 0.000, 0.000, 78.887, 78.887] as [Float]
		...
		mãoDedoTranslationXAnimation.values = [0.000, 0.000, -130.000, -130.000, 77.826, 77.826] as [Float]
		...
		mãoDedoTranslationYAnimation.values = [0.000, 0.000, 0.000, 79.420, 79.420] as [Float]
		...
		let garroteP6OpacityAnimation = CAKeyframeAnimation(keyPath: "opacity")
		garroteP6OpacityAnimation.duration = 15.000
		garroteP6OpacityAnimation.values = [1.000, 1.000, 0.000, 0.000] as [Float]
		garroteP6OpacityAnimation.keyTimes = [0.000, 0.115, 0.155, 1.000] as [NSNumber]
		garroteP6OpacityAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		garroteP6OpacityAnimation.beginTime = beginTime
		garroteP6OpacityAnimation.fillMode = fillMode
		garroteP6OpacityAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["GarroteP6__root"]?.layer.add(garroteP6OpacityAnimation, forKey:"Passo6_Opacity")
	...
	func removePasso6Animation() {
		...
		self.viewsByName["MedidaP6__root"]?.layer.removeAnimation(forKey: "Passo6_Opacity")
		self.viewsByName["MedidaP6__root"]?.layer.removeAnimation(forKey: "Passo6_TranslationX")
		self.viewsByName["MedidaP6__root"]?.layer.removeAnimation(forKey: "Passo6_TranslationY")
		...
		self.viewsByName["GarroteP6__root"]?.layer.removeAnimation(forKey: "Passo6_Opacity")
