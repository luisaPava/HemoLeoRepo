...
class ButtonAnimation {
    ...
    static func addButtonPressAnimationToView(viewToAnimate: UIView) {
        ...
        modeloBotaoScaleXAnimation.keyTimes = [0.000 as Float, 0.286 as Float, 0.643 as Float, 1.000 as Float]
        modeloBotaoScaleXAnimation.timingFunctions = [anticOverTiming, anticOverTiming, overshootTiming]
        viewToAnimate.layer.addAnimation(modeloBotaoScaleXAnimation, forKey:"ButtonPress_ScaleX")
        ...
        modeloBotaoScaleYAnimation.keyTimes = [0.000 as Float, 0.286 as Float, 0.643 as Float, 1.000 as Float]
        modeloBotaoScaleYAnimation.timingFunctions = [anticOverTiming, anticOverTiming, overshootTiming]
        viewToAnimate.layer.addAnimation(modeloBotaoScaleYAnimation, forKey:"ButtonPress_ScaleY")
    }
}