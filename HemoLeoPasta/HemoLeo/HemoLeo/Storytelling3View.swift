...
class Storytelling3View : UIView, CAAnimationDelegate {
	...
	func setupHierarchy() {
		...
		leoMachucado__root.layer.position = CGPoint(x:181.000, y:214.000)
		...
		soldados__root.layer.position = CGPoint(x:733.925, y:526.061)
	...
	func addStory2Animation(beginTime: CFTimeInterval, fillMode: String, removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
		...
		leoMachucadoOpacityAnimation.keyTimes = [0.000, 0.800, 0.900, 1.000] as [NSNumber]
		leoMachucadoOpacityAnimation.timingFunctions = [anticOverTiming, linearTiming, linearTiming]
		...
		machucadoCabeçaScaleXAnimation.keyTimes = [0.000, 0.107, 0.127, 0.152, 0.175, 0.202, 0.228, 0.260, 0.667, 0.800, 1.000] as [NSNumber]
		...
		machucadoCabeçaScaleYAnimation.keyTimes = [0.000, 0.107, 0.127, 0.152, 0.175, 0.202, 0.228, 0.260, 0.667, 0.800, 1.000] as [NSNumber]
